...
public class CountryService {
	...
	//The annotation will obtain the information from the cache CATALOG_COUNTRY
	// before invoke the real implementation if the information not exist try to obtain the information and saved unless
